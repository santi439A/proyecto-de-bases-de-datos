-- =====================================================
-- QUINDIOFLIX - CREACION DE TABLESPACES Y TABLAS
-- Base de Datos II
-- Ejecutar con un usuario que tenga privilegios para
-- CREATE TABLESPACE, CREATE TABLE, CREATE SEQUENCE e INDEX
-- =====================================================

-- Nota:
-- Si Oracle requiere ruta completa para los datafiles,
-- ajustar los nombres de archivo antes de ejecutar.
...
CREATE TABLE plan (
    ...
    CONSTRAINT pk_plan PRIMARY KEY (plan_id)
        USING INDEX TABLESPACE ts_quindioflix_indx,
...
PARTITION BY RANGE (fecha_inicio) (
    PARTITION p2025 VALUES LESS THAN (TO_TIMESTAMP('2026-01-01 00:00:00','YYYY-MM-DD HH24:MI:SS')),
    PARTITION p2026 VALUES LESS THAN (TO_TIMESTAMP('2027-01-01 00:00:00','YYYY-MM-DD HH24:MI:SS')),
...
CREATE INDEX idx_contenido_categoria_anno
    ...
    TABLESPACE ts_quindioflix_indx;
...
CREATE INDEX idx_reproduccion_perfil_fecha
    ...
    LOCAL TABLESPACE ts_quindioflix_indx;
